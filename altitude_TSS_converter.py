...
LTpwr = 300                         # threshold power
LivingAlt = 5500                    # in feet
...
AltConvert = ((((AvgAlt) - LivingAlt) / 500)/100)         # change altitude factor here if you know yours
AltLTpwr = (LTpwr*(1-AltConvert))

##### CONVERT ACTVITY TIME TO SECONDS #####
time = '1:30:00'                    # input activity time here hh:mm:ss
...
##### CALCULATE BASELINE AND ALTITUDE IF #####
IFpwr = AvgPwr / LTpwr
